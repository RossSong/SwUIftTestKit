...
class UICollectionViewWrapper: NSObject, UICollectionViewWrapperProtocol, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
